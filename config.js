export const MAIL_CONSTRUCTION_CRON = process.env.MAIL_CONSTRUCTION_CRON || '0 16 15 * * *'; // NOTE: set to run every day at 8:15
export const SENDER = process.env.FROM_EMAIL_ADDRESS || '';
